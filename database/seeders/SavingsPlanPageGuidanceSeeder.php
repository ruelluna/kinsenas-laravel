...
class SavingsPlanPageGuidanceSeeder extends Seeder
{
    public function run(): void
    {
        SavingsPlanPageGuidance::query()->firstOrCreate(
            [],
            [
                'chooser_intro' => 'Choose the savings formula that fits how you want to divide your income. You can add custom categories later, but your percentage split is set when you enter your first income.',
                'chooser_video_url' => null,
                'before_choose_note' => 'You can only have one savings plan per team. After you save your first income entry, percentage categories lock — so pick the formula that matches your goals before entering income.',
