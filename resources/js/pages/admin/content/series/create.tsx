...
export default function AdminContentSeriesCreate() {
    return (
        <>
            <Head title="Admin — New series" />
            <Heading variant="small" title="New series" />
            <Form action="/admin/content/series" method="post" className="mt-6 max-w-2xl space-y-4">
                ...
                <div className="flex gap-2">
                    ...
                    <Button variant="outline" asChild>
                        <Link href="/admin/content/series">Cancel</Link>
                    </Button>
                </div>
            </Form>
        </>
