    ...
    return (
        <>
            ...
            <Heading
                variant="small"
                title="PayMaya QR"
                description="Replace the QR shown to subscribers."
            />
            <Form
                action="/admin/payment-qr"
                method="post"
            ...
            >
                <div className="grid gap-2">
                    ...
                    <Input
                        id="label"
                        name="label"
                        defaultValue={config?.label ?? 'PayMaya'}
                        required
                    />
                </div>
                <div className="grid gap-2">
                    ...
                    <textarea
                        ...
                        className="min-h-24 rounded-md border border-input px-3 py-2 text-sm"
                    />
                </div>
                <div className="grid gap-2">
