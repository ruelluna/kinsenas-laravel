...
import type { DashboardActivityItem, DashboardFeatures, DashboardQuickLinks } from '@/types/dashboard';
...
export default function RecentActivityFeed({ recentActivity, quickLinks, features }: Props) {
    return (
        <div className="rounded-lg border p-4">
            ...
            <div className="mt-3 flex flex-wrap gap-4 text-sm text-muted-foreground">
                <Link href={quickLinks.spending} className="text-primary underline-offset-4 hover:underline">
                    View all spending
                </Link>
                {features.transfers && (
